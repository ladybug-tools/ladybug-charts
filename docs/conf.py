...
htmlhelp_basename = 'ladybugchartsdoc'
...
latex_documents = [
    (master_doc, 'ladybug-charts.tex', 'ladybug-charts Documentation',
...
man_pages = [
    (master_doc, 'ladybug-charts', 'ladybug-charts Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ladybug-charts', 'ladybug-charts Documentation',
     author, 'ladybug-charts', 'One line description of project.',
     'Miscellaneous'),
]
