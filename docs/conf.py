...
latex_documents = [
    (master_doc, 'ladybug-chart.tex', 'ladybug-chart Documentation',
...
man_pages = [
    (master_doc, 'ladybug-chart', 'ladybug-chart Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ladybug-chart', 'ladybug-chart Documentation',
     author, 'ladybug-chart', 'One line description of project.',
     'Miscellaneous'),
]
